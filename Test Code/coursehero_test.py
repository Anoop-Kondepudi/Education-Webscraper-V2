...
ses.get('https://www.coursehero.com')
ses.get('https://www.coursehero.com/csp-beta')
...
print(captcha)
url = "https://www.coursehero.com/api/v2/login/"
data = {"email": "testing5498@yopmail.com",
    "g-recaptcha-response": captcha,
    "password": "testing5498@yopmail.comtesting5498@yopmail.com",
    "remember_me": 1,
    "submit": True,}
...
print(ses.post(url, json=data, headers=headers))